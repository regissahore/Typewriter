...
public:
    enum GOParameterType
    {
        ...
        PARAMETER_GO_MARKOV_1_FAILURE_1,
        PARAMETER_GO_MARKOV_1_REPAIR_1,
        PARAMETER_GO_MARKOV_1_REPAIR_TIME_1,
        PARAMETER_GO_MARKOV_1_FAILURE_2,
        PARAMETER_GO_MARKOV_1_REPAIR_2,
        PARAMETER_GO_MARKOV_1_REPAIR_TIME_2,
        PARAMETER_GO_MARKOV_9_FAILURE_FEEDBACK,
        PARAMETER_GO_MARKOV_9_REPAIR_FEEDBACK,
        PARAMETER_GO_MARKOV_9_REPAIR_TIME_FEEDBACK,
        PARAMETER_GO_MARKOV_13_A
    };
