...
MainMenuAnalysis::MainMenuAnalysis()
{
    ...
    this->_actionProbability = this->addAction(QIcon(":icon/resouce/image/start.png"), tr("Analysis Probability"));
    this->_actionPath = this->addAction(QIcon(":icon/resouce/image/path.png"), tr("Find Path Set"));
    this->_actionCut = this->addAction(QIcon(":icon/resouce/image/cut.png"), tr("Find Cut Set"));
