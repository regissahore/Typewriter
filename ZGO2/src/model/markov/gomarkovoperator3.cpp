...
bool GOMarkovOperator3::isDualBreakdown() const
{
    return this->_isDualBreakdown;
}

bool GOMarkovOperator3::isBreakdownCorrelate() const
{
    return this->_isBreakdownCorrelate;
}

void GOMarkovOperator3::setDualBreakdown(bool value)
{
    this->_isDualBreakdown = value;
}

void GOMarkovOperator3::setBreakdownCorrelate(bool value)
{
    this->_isBreakdownCorrelate = value;
}

GOMarkovStatus* GOMarkovOperator3::markovStatus2() const
{
    return this->_markovStatus2;
}

void GOMarkovOperator3::initMarkovStatus(double time, double c12)
{
...
void GOMarkovOperator3::calcOutputMarkovStatus(double time)
{
    Q_UNUSED(time);
...
void GOMarkovOperator3::calcOutputMarkovStatusNormal()
{
...
void GOMarkovOperator3::calcOutputMarkovStatusCorrelate()
{
    GOSignal *signal = this->input()->signal()->at(0);
    GOMarkovOperator *prev = (GOMarkovOperator*)signal->next(this);
    int index = prev->output()->getSignalIndex(signal);
...
void GOMarkovOperator3::save(QDomDocument &document, QDomElement &root)
{
...
bool GOMarkovOperator3::tryOpen(QDomElement &root)
{
