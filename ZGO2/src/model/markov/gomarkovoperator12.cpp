...
bool GOMarkovOperator12::isDualBreakdown() const
{
    return this->_isDualBreakdown;
}

bool GOMarkovOperator12::isBreakdownCorrelate() const
{
    return this->_isBreakdownCorrelate;
}

void GOMarkovOperator12::setDualBreakdown(bool value)
{
    this->_isDualBreakdown = value;
}

void GOMarkovOperator12::setBreakdownCorrelate(bool value)
{
    this->_isBreakdownCorrelate = value;
}

GOMarkovStatus* GOMarkovOperator12::markovStatus2() const
{
    return this->_markovStatus2;
}

void GOMarkovOperator12::initMarkovStatus(double time, double c12)
{
...
void GOMarkovOperator12::calcOutputMarkovStatus(double time)
{
    Q_UNUSED(time);
...
void GOMarkovOperator12::calcOutputMarkovStatusNormal()
{
...
void GOMarkovOperator12::calcOutputMarkovStatusCorrelate()
{
    GOSignal *signal = this->input()->signal()->at(0);
    GOMarkovOperator *prev = (GOMarkovOperator*)signal->next(this);
    int index = prev->output()->getSignalIndex(signal);
...
void GOMarkovOperator12::save(QDomDocument &document, QDomElement &root)
{
...
bool GOMarkovOperator12::tryOpen(QDomElement &root)
{
