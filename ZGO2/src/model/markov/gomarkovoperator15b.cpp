...
bool GOMarkovOperator15B::isDualBreakdown() const
{
    return this->_isDualBreakdown;
}

bool GOMarkovOperator15B::isBreakdownCorrelate() const
{
    return this->_isBreakdownCorrelate;
}

void GOMarkovOperator15B::setDualBreakdown(bool value)
{
    this->_isDualBreakdown = value;
}

void GOMarkovOperator15B::setBreakdownCorrelate(bool value)
{
    this->_isBreakdownCorrelate = value;
}

GOMarkovStatus* GOMarkovOperator15B::markovStatus2() const
{
    return this->_markovStatus2;
}

void GOMarkovOperator15B::initMarkovStatus(double time, double c12)
{
...
void GOMarkovOperator15B::calcOutputMarkovStatusNormal()
{
...
void GOMarkovOperator15B::calcOutputMarkovStatusCorrelate()
{
    GOSignal *signal = this->input()->signal()->at(0);
    GOMarkovOperator *prev = (GOMarkovOperator*)signal->next(this);
    int index = prev->output()->getSignalIndex(signal);
...
void GOMarkovOperator15B::save(QDomDocument &document, QDomElement &root)
{
...
bool GOMarkovOperator15B::tryOpen(QDomElement &root)
{
