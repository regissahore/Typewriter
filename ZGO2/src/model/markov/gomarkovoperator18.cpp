...
bool GOMarkovOperator18::isDualBreakdown() const
{
    return this->_isDualBreakdown;
}

bool GOMarkovOperator18::isBreakdownCorrelate() const
{
    return this->_isBreakdownCorrelate;
}

void GOMarkovOperator18::setDualBreakdown(bool value)
{
    this->_isDualBreakdown = value;
}

void GOMarkovOperator18::setBreakdownCorrelate(bool value)
{
    this->_isBreakdownCorrelate = value;
}

GOMarkovStatus* GOMarkovOperator18::markovStatus2() const
{
    return this->_markovStatus2;
}

void GOMarkovOperator18::initMarkovStatus(double time, double c12)
{
...
void GOMarkovOperator18::calcOutputMarkovStatusNormal()
{
...
void GOMarkovOperator18::calcOutputMarkovStatusCorrelate()
{
    GOSignal *signal = this->input()->signal()->at(0);
    GOMarkovOperator *prev = (GOMarkovOperator*)signal->next(this);
    int index = prev->output()->getSignalIndex(signal);
