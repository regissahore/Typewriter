...
GOMarkovOperator9A1::GOMarkovOperator9A1() : GOMarkovOperator()
{
...
bool GOMarkovOperator9A1::isDualBreakdown() const
{
    return this->_isDualBreakdown;
}

bool GOMarkovOperator9A1::isBreakdownCorrelate() const
{
    return this->_isBreakdownCorrelate;
}

void GOMarkovOperator9A1::setDualBreakdown(bool value)
{
    this->_isDualBreakdown = value;
}

void GOMarkovOperator9A1::setBreakdownCorrelate(bool value)
{
    this->_isBreakdownCorrelate = value;
}

GOMarkovStatus* GOMarkovOperator9A1::markovStatus2() const
{
    return this->_markovStatus2;
}

void GOMarkovOperator9A1::initMarkovStatus(double time, double c12)
{
...
void GOMarkovOperator9A1::calcOutputMarkovStatusNormal()
{
...
void GOMarkovOperator9A1::calcOutputMarkovStatusCorrelate()
{
    GOSignal *signal = this->input()->signal()->at(0);
    GOMarkovOperator *prev = (GOMarkovOperator*)signal->next(this);
    int index = prev->output()->getSignalIndex(signal);
...
void GOMarkovOperator9A1::save(QDomDocument &document, QDomElement &root)
{
...
bool GOMarkovOperator9A1::tryOpen(QDomElement &root)
{
