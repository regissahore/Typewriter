...
bool GOMarkovOperator29::isDualBreakdown() const
{
    return this->_isDualBreakdown;
}

bool GOMarkovOperator29::isBreakdownCorrelate() const
{
    return this->_isBreakdownCorrelate;
}

void GOMarkovOperator29::setDualBreakdown(bool value)
{
    this->_isDualBreakdown = value;
}

void GOMarkovOperator29::setBreakdownCorrelate(bool value)
{
    this->_isBreakdownCorrelate = value;
}

GOMarkovStatus* GOMarkovOperator29::markovStatus2() const
{
    return this->_markovStatus2;
}

void GOMarkovOperator29::initMarkovStatus(double time, double c12)
{
...
void GOMarkovOperator29::calcOutputMarkovStatus(double time)
{
    Q_UNUSED(time);
...
void GOMarkovOperator29::calcOutputMarkovStatusNormal()
{
...
void GOMarkovOperator29::calcOutputMarkovStatusCorrelate()
{
    GOSignal *signal = this->input()->signal()->at(0);
    GOMarkovOperator *prev = (GOMarkovOperator*)signal->next(this);
    int index = prev->output()->getSignalIndex(signal);
...
void GOMarkovOperator29::save(QDomDocument &document, QDomElement &root)
{
...
bool GOMarkovOperator29::tryOpen(QDomElement &root)
{
