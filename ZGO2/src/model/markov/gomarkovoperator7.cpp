...
bool GOMarkovOperator7::isDualBreakdown() const
{
    return this->_isDualBreakdown;
}

bool GOMarkovOperator7::isBreakdownCorrelate() const
{
    return this->_isBreakdownCorrelate;
}

void GOMarkovOperator7::setDualBreakdown(bool value)
{
    this->_isDualBreakdown = value;
}

void GOMarkovOperator7::setBreakdownCorrelate(bool value)
{
    this->_isBreakdownCorrelate = value;
}

GOMarkovStatus* GOMarkovOperator7::markovStatus2() const
{
    return this->_markovStatus2;
}

void GOMarkovOperator7::initMarkovStatus(double time, double c12)
{
...
void GOMarkovOperator7::calcOutputMarkovStatus(double time)
{
    Q_UNUSED(time);
...
void GOMarkovOperator7::calcOutputMarkovStatusNormal()
{
...
void GOMarkovOperator7::calcOutputMarkovStatusCorrelate()
{
    GOSignal *signal = this->input()->signal()->at(0);
    GOMarkovOperator *prev = (GOMarkovOperator*)signal->next(this);
    int index = prev->output()->getSignalIndex(signal);
...
void GOMarkovOperator7::save(QDomDocument &document, QDomElement &root)
{
...
bool GOMarkovOperator7::tryOpen(QDomElement &root)
{
