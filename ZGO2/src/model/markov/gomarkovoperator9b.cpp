...
bool GOMarkovOperator9B::isDualBreakdown() const
{
    return this->_isDualBreakdown;
}

bool GOMarkovOperator9B::isBreakdownCorrelate() const
{
    return this->_isBreakdownCorrelate;
}

void GOMarkovOperator9B::setDualBreakdown(bool value)
{
    this->_isDualBreakdown = value;
}

void GOMarkovOperator9B::setBreakdownCorrelate(bool value)
{
    this->_isBreakdownCorrelate = value;
}

GOMarkovStatus* GOMarkovOperator9B::markovStatus2() const
{
    return this->_markovStatus2;
}

void GOMarkovOperator9B::initMarkovStatus(double time, double c12)
{
...
void GOMarkovOperator9B::calcOutputMarkovStatus(double time)
{
    Q_UNUSED(time);
...
void GOMarkovOperator9B::calcOutputMarkovStatusNormal()
{
...
void GOMarkovOperator9B::calcOutputMarkovStatusCorrelate()
{
    GOSignal *signal = this->input()->signal()->at(0);
    GOMarkovOperator *prev = (GOMarkovOperator*)signal->next(this);
    int index = prev->output()->getSignalIndex(signal);
...
void GOMarkovOperator9B::save(QDomDocument &document, QDomElement &root)
{
...
bool GOMarkovOperator9B::tryOpen(QDomElement &root)
{
