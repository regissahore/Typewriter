...
bool GOMarkovOperator20::isDualBreakdown() const
{
    return this->_isDualBreakdown;
}

bool GOMarkovOperator20::isBreakdownCorrelate() const
{
    return this->_isBreakdownCorrelate;
}

void GOMarkovOperator20::setDualBreakdown(bool value)
{
    this->_isDualBreakdown = value;
}

void GOMarkovOperator20::setBreakdownCorrelate(bool value)
{
    this->_isBreakdownCorrelate = value;
}

GOMarkovStatus* GOMarkovOperator20::markovStatus2() const
{
    return this->_markovStatus2;
}

void GOMarkovOperator20::initMarkovStatus(double time, double c12)
{
...
void GOMarkovOperator20::calcOutputMarkovStatusNormal()
{
...
void GOMarkovOperator20::calcOutputMarkovStatusCorrelate()
{
    GOSignal *signal = this->input()->signal()->at(0);
    GOMarkovOperator *prev = (GOMarkovOperator*)signal->next(this);
    int index = prev->output()->getSignalIndex(signal);
...
void GOMarkovOperator20::save(QDomDocument &document, QDomElement &root)
{
...
bool GOMarkovOperator20::tryOpen(QDomElement &root)
{
