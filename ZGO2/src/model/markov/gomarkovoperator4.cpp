...
bool GOMarkovOperator4::isDualBreakdown() const
{
    return this->_isDualBreakdown;
}

bool GOMarkovOperator4::isBreakdownCorrelate() const
{
    return this->_isBreakdownCorrelate;
}

void GOMarkovOperator4::setDualBreakdown(bool value)
{
    this->_isDualBreakdown = value;
}

void GOMarkovOperator4::setBreakdownCorrelate(bool value)
{
    this->_isBreakdownCorrelate = value;
}

GOMarkovStatus* GOMarkovOperator4::markovStatus2() const
{
    return this->_markovStatus2;
}

void GOMarkovOperator4::initMarkovStatus(double time, double c12)
{
...
void GOMarkovOperator4::calcOutputMarkovStatus(double time)
{
    Q_UNUSED(time);
...
void GOMarkovOperator4::calcOutputMarkovStatusNormal()
{
...
void GOMarkovOperator4::calcOutputMarkovStatusCorrelate()
{
    GOSignal *signal = this->input()->signal()->at(0);
    GOMarkovOperator *prev = (GOMarkovOperator*)signal->next(this);
    int index = prev->output()->getSignalIndex(signal);
...
void GOMarkovOperator4::save(QDomDocument &document, QDomElement &root)
{
...
bool GOMarkovOperator4::tryOpen(QDomElement &root)
{
