...
bool GOMarkovOperator19::isDualBreakdown() const
{
    return this->_isDualBreakdown;
}

bool GOMarkovOperator19::isBreakdownCorrelate() const
{
    return this->_isBreakdownCorrelate;
}

void GOMarkovOperator19::setDualBreakdown(bool value)
{
    this->_isDualBreakdown = value;
}

void GOMarkovOperator19::setBreakdownCorrelate(bool value)
{
    this->_isBreakdownCorrelate = value;
}

GOMarkovStatus* GOMarkovOperator19::markovStatus2() const
{
    return this->_markovStatus2;
}

void GOMarkovOperator19::initMarkovStatus(double time, double c12)
{
...
void GOMarkovOperator19::calcOutputMarkovStatusNormal()
{
...
void GOMarkovOperator19::calcOutputMarkovStatusCorrelate()
{
    GOSignal *signal = this->input()->signal()->at(0);
    GOMarkovOperator *prev = (GOMarkovOperator*)signal->next(this);
    int index = prev->output()->getSignalIndex(signal);
