...
bool GOMarkovOperator2::isDualBreakdown() const
{
    return this->_isDualBreakdown;
}

bool GOMarkovOperator2::isBreakdownCorrelate() const
{
    return this->_isBreakdownCorrelate;
}

void GOMarkovOperator2::setDualBreakdown(bool value)
{
    this->_isDualBreakdown = value;
}

void GOMarkovOperator2::setBreakdownCorrelate(bool value)
{
    this->_isBreakdownCorrelate = value;
}

GOMarkovStatus* GOMarkovOperator2::markovStatus2() const
{
    return this->_markovStatus2;
}

void GOMarkovOperator2::initMarkovStatus(double time, double c12)
{
...
void GOMarkovOperator2::calcOutputMarkovStatusNormal()
{
...
void GOMarkovOperator2::calcOutputMarkovStatusCorrelate()
{
    GOSignal *signal = this->input()->signal()->at(0);
    GOMarkovOperator *prev = (GOMarkovOperator*)signal->next(this);
    int index = prev->output()->getSignalIndex(signal);
