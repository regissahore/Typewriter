...
bool GOMarkovOperator5::isDualBreakdown() const
{
    return this->_isDualBreakdown;
}

bool GOMarkovOperator5::isBreakdownCorrelate() const
{
    return this->_isBreakdownCorrelate;
}

void GOMarkovOperator5::setDualBreakdown(bool value)
{
    this->_isDualBreakdown = value;
}

void GOMarkovOperator5::setBreakdownCorrelate(bool value)
{
    this->_isBreakdownCorrelate = value;
}

GOMarkovStatus* GOMarkovOperator5::markovStatus2() const
{
    return this->_markovStatus2;
}

void GOMarkovOperator5::initMarkovStatus(double time, double c12)
{
...
void GOMarkovOperator5::calcOutputMarkovStatusNormal()
{
...
void GOMarkovOperator5::calcOutputMarkovStatusCorrelate()
{
    GOSignal *signal = this->input()->signal()->at(0);
    GOMarkovOperator *prev = (GOMarkovOperator*)signal->next(this);
    int index = prev->output()->getSignalIndex(signal);
...
void GOMarkovOperator5::save(QDomDocument &document, QDomElement &root)
{
...
bool GOMarkovOperator5::tryOpen(QDomElement &root)
{
