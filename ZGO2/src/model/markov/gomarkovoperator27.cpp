...
bool GOMarkovOperator27::isDualBreakdown() const
{
    return this->_isDualBreakdown;
}

bool GOMarkovOperator27::isBreakdownCorrelate() const
{
    return this->_isBreakdownCorrelate;
}

void GOMarkovOperator27::setDualBreakdown(bool value)
{
    this->_isDualBreakdown = value;
}

void GOMarkovOperator27::setBreakdownCorrelate(bool value)
{
    this->_isBreakdownCorrelate = value;
}

GOMarkovStatus* GOMarkovOperator27::markovStatus2() const
{
    return this->_markovStatus2;
}

void GOMarkovOperator27::initMarkovStatus(double time, double c12)
{
...
void GOMarkovOperator27::calcOutputMarkovStatus(double time)
{
    Q_UNUSED(time);
...
void GOMarkovOperator27::calcOutputMarkovStatusNormal()
{
...
void GOMarkovOperator27::calcOutputMarkovStatusCorrelate()
{
    GOSignal *signal = this->input()->signal()->at(0);
    GOMarkovOperator *prev = (GOMarkovOperator*)signal->next(this);
    int index = prev->output()->getSignalIndex(signal);
...
void GOMarkovOperator27::save(QDomDocument &document, QDomElement &root)
{
...
bool GOMarkovOperator27::tryOpen(QDomElement &root)
{
