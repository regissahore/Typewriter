...
bool GOMarkovOperator28::isDualBreakdown() const
{
    return this->_isDualBreakdown;
}

bool GOMarkovOperator28::isBreakdownCorrelate() const
{
    return this->_isBreakdownCorrelate;
}

void GOMarkovOperator28::setDualBreakdown(bool value)
{
    this->_isDualBreakdown = value;
}

void GOMarkovOperator28::setBreakdownCorrelate(bool value)
{
    this->_isBreakdownCorrelate = value;
}

GOMarkovStatus* GOMarkovOperator28::markovStatus2() const
{
    return this->_markovStatus2;
}

void GOMarkovOperator28::initMarkovStatus(double time, double c12)
{
...
void GOMarkovOperator28::calcOutputMarkovStatus(double time)
{
    Q_UNUSED(time);
...
void GOMarkovOperator28::calcOutputMarkovStatusNormal()
{
...
void GOMarkovOperator28::calcOutputMarkovStatusCorrelate()
{
    GOSignal *signal = this->input()->signal()->at(0);
    GOMarkovOperator *prev = (GOMarkovOperator*)signal->next(this);
    int index = prev->output()->getSignalIndex(signal);
...
void GOMarkovOperator28::save(QDomDocument &document, QDomElement &root)
{
...
bool GOMarkovOperator28::tryOpen(QDomElement &root)
{
