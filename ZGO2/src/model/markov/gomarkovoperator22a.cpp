...
GOMarkovOperator22A::GOMarkovOperator22A() : GOMarkovOperator()
{
...
bool GOMarkovOperator22A::isDualBreakdown() const
{
    return this->_isDualBreakdown;
}

bool GOMarkovOperator22A::isBreakdownCorrelate() const
{
    return this->_isBreakdownCorrelate;
}

void GOMarkovOperator22A::setDualBreakdown(bool value)
{
    this->_isDualBreakdown = value;
}

void GOMarkovOperator22A::setBreakdownCorrelate(bool value)
{
    this->_isBreakdownCorrelate = value;
}

GOMarkovStatus* GOMarkovOperator22A::markovStatus2() const
{
    return this->_markovStatus2;
}

void GOMarkovOperator22A::initMarkovStatus(double time, double c12)
{
...
void GOMarkovOperator22A::calcOutputMarkovStatusNormal()
{
...
void GOMarkovOperator22A::calcOutputMarkovStatusCorrelate()
{
    GOSignal *signal = this->input()->signal()->at(0);
    GOMarkovOperator *prev = (GOMarkovOperator*)signal->next(this);
    int index = prev->output()->getSignalIndex(signal);
...
void GOMarkovOperator22A::save(QDomDocument &document, QDomElement &root)
{
...
bool GOMarkovOperator22A::tryOpen(QDomElement &root)
{
