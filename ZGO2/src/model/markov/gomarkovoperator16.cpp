...
bool GOMarkovOperator16::isDualBreakdown() const
{
    return this->_isDualBreakdown;
}

bool GOMarkovOperator16::isBreakdownCorrelate() const
{
    return this->_isBreakdownCorrelate;
}

void GOMarkovOperator16::setDualBreakdown(bool value)
{
    this->_isDualBreakdown = value;
}

void GOMarkovOperator16::setBreakdownCorrelate(bool value)
{
    this->_isBreakdownCorrelate = value;
}

GOMarkovStatus* GOMarkovOperator16::markovStatus2() const
{
    return this->_markovStatus2;
}

void GOMarkovOperator16::initMarkovStatus(double time, double c12)
{
...
void GOMarkovOperator16::save(QDomDocument &document, QDomElement &root)
{
...
bool GOMarkovOperator16::tryOpen(QDomElement &root)
{
