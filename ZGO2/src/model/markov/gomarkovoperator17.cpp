...
bool GOMarkovOperator17::isDualBreakdown() const
{
    return this->_isDualBreakdown;
}

bool GOMarkovOperator17::isBreakdownCorrelate() const
{
    return this->_isBreakdownCorrelate;
}

void GOMarkovOperator17::setDualBreakdown(bool value)
{
    this->_isDualBreakdown = value;
}

void GOMarkovOperator17::setBreakdownCorrelate(bool value)
{
    this->_isBreakdownCorrelate = value;
}

GOMarkovStatus* GOMarkovOperator17::markovStatus2() const
{
    return this->_markovStatus2;
}

void GOMarkovOperator17::initMarkovStatus(double time, double c12)
{
...
void GOMarkovOperator17::save(QDomDocument &document, QDomElement &root)
{
...
bool GOMarkovOperator17::tryOpen(QDomElement &root)
{
