...
GOMarkovOperator22B::GOMarkovOperator22B() : GOMarkovOperator()
{
...
bool GOMarkovOperator22B::isDualBreakdown() const
{
    return this->_isDualBreakdown;
}

bool GOMarkovOperator22B::isBreakdownCorrelate() const
{
    return this->_isBreakdownCorrelate;
}

void GOMarkovOperator22B::setDualBreakdown(bool value)
{
    this->_isDualBreakdown = value;
}

void GOMarkovOperator22B::setBreakdownCorrelate(bool value)
{
    this->_isBreakdownCorrelate = value;
}

GOMarkovStatus* GOMarkovOperator22B::markovStatus2() const
{
    return this->_markovStatus2;
}

void GOMarkovOperator22B::initMarkovStatus(double time, double c12)
{
...
void GOMarkovOperator22B::calcOutputMarkovStatusNormal()
{
...
void GOMarkovOperator22B::calcOutputMarkovStatusCorrelate()
{
    GOSignal *signal = this->input()->signal()->at(0);
    GOMarkovOperator *prev = (GOMarkovOperator*)signal->next(this);
    int index = prev->output()->getSignalIndex(signal);
...
void GOMarkovOperator22B::save(QDomDocument &document, QDomElement &root)
{
...
bool GOMarkovOperator22B::tryOpen(QDomElement &root)
{
