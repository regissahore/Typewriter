...
bool GOMarkovOperator22::isDualBreakdown() const
{
    return this->_isDualBreakdown;
}

bool GOMarkovOperator22::isBreakdownCorrelate() const
{
    return this->_isBreakdownCorrelate;
}

void GOMarkovOperator22::setDualBreakdown(bool value)
{
    this->_isDualBreakdown = value;
}

void GOMarkovOperator22::setBreakdownCorrelate(bool value)
{
    this->_isBreakdownCorrelate = value;
}

GOMarkovStatus* GOMarkovOperator22::markovStatus2() const
{
    return this->_markovStatus2;
}

void GOMarkovOperator22::initMarkovStatus(double time, double c12)
{
...
void GOMarkovOperator22::calcOutputMarkovStatus(double time)
{
    Q_UNUSED(time);
...
void GOMarkovOperator22::calcOutputMarkovStatusNormal()
{
...
void GOMarkovOperator22::calcOutputMarkovStatusCorrelate()
{
    GOSignal *signal = this->input()->signal()->at(0);
    GOMarkovOperator *prev = (GOMarkovOperator*)signal->next(this);
    int index = prev->output()->getSignalIndex(signal);
