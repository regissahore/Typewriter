...
bool GOMarkovOperator26::isDualBreakdown() const
{
    return this->_isDualBreakdown;
}

bool GOMarkovOperator26::isBreakdownCorrelate() const
{
    return this->_isBreakdownCorrelate;
}

void GOMarkovOperator26::setDualBreakdown(bool value)
{
    this->_isDualBreakdown = value;
}

void GOMarkovOperator26::setBreakdownCorrelate(bool value)
{
    this->_isBreakdownCorrelate = value;
}

GOMarkovStatus* GOMarkovOperator26::markovStatus2() const
{
    return this->_markovStatus2;
}

void GOMarkovOperator26::initMarkovStatus(double time, double c12)
{
...
void GOMarkovOperator26::calcOutputMarkovStatus(double time)
{
    Q_UNUSED(time);
...
void GOMarkovOperator26::calcOutputMarkovStatusNormal()
{
...
void GOMarkovOperator26::calcOutputMarkovStatusCorrelate()
{
    GOSignal *signal = this->input()->signal()->at(0);
    GOMarkovOperator *prev = (GOMarkovOperator*)signal->next(this);
    int index = prev->output()->getSignalIndex(signal);
...
void GOMarkovOperator26::save(QDomDocument &document, QDomElement &root)
{
...
bool GOMarkovOperator26::tryOpen(QDomElement &root)
{
