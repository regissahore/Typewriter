...
bool GOMarkovOperator14::isDualBreakdown() const
{
    return this->_isDualBreakdown;
}

bool GOMarkovOperator14::isBreakdownCorrelate() const
{
    return this->_isBreakdownCorrelate;
}

void GOMarkovOperator14::setDualBreakdown(bool value)
{
    this->_isDualBreakdown = value;
}

void GOMarkovOperator14::setBreakdownCorrelate(bool value)
{
    this->_isBreakdownCorrelate = value;
}

GOMarkovStatus* GOMarkovOperator14::markovStatus2() const
{
    return this->_markovStatus2;
}

void GOMarkovOperator14::initMarkovStatus(double time, double c12)
{
...
void GOMarkovOperator14::calcOutputMarkovStatus(double time)
{
    Q_UNUSED(time);
...
void GOMarkovOperator14::calcOutputMarkovStatusNormal()
{
...
void GOMarkovOperator14::calcOutputMarkovStatusCorrelate()
{
    GOSignal *signal = this->input()->signal()->at(0);
    GOMarkovOperator *prev = (GOMarkovOperator*)signal->next(this);
    int index = prev->output()->getSignalIndex(signal);
...
void GOMarkovOperator14::save(QDomDocument &document, QDomElement &root)
{
...
bool GOMarkovOperator14::tryOpen(QDomElement &root)
{
