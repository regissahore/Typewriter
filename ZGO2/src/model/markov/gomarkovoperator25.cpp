...
bool GOMarkovOperator25::isDualBreakdown() const
{
    return this->_isDualBreakdown;
}

bool GOMarkovOperator25::isBreakdownCorrelate() const
{
    return this->_isBreakdownCorrelate;
}

void GOMarkovOperator25::setDualBreakdown(bool value)
{
    this->_isDualBreakdown = value;
}

void GOMarkovOperator25::setBreakdownCorrelate(bool value)
{
    this->_isBreakdownCorrelate = value;
}

GOMarkovStatus* GOMarkovOperator25::markovStatus2() const
{
    return this->_markovStatus2;
}

void GOMarkovOperator25::initMarkovStatus(double time, double c12)
{
...
void GOMarkovOperator25::calcOutputMarkovStatus(double time)
{
    Q_UNUSED(time);
...
void GOMarkovOperator25::calcOutputMarkovStatusNormal()
{
...
void GOMarkovOperator25::calcOutputMarkovStatusCorrelate()
{
    GOSignal *signal = this->input()->signal()->at(0);
    GOMarkovOperator *prev = (GOMarkovOperator*)signal->next(this);
    int index = prev->output()->getSignalIndex(signal);
...
void GOMarkovOperator25::save(QDomDocument &document, QDomElement &root)
{
...
bool GOMarkovOperator25::tryOpen(QDomElement &root)
{
