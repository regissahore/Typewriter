...
bool GOMarkovOperator9A2::isDualBreakdown() const
{
    return this->_isDualBreakdown;
}

bool GOMarkovOperator9A2::isBreakdownCorrelate() const
{
    return this->_isBreakdownCorrelate;
}

void GOMarkovOperator9A2::setDualBreakdown(bool value)
{
    this->_isDualBreakdown = value;
}

void GOMarkovOperator9A2::setBreakdownCorrelate(bool value)
{
    this->_isBreakdownCorrelate = value;
}

GOMarkovStatus* GOMarkovOperator9A2::markovStatus2() const
{
    return this->_markovStatus2;
}

void GOMarkovOperator9A2::initMarkovStatus(double time, double c12)
{
...
void GOMarkovOperator9A2::calcOutputMarkovStatusNormal()
{
...
void GOMarkovOperator9A2::calcOutputMarkovStatusCorrelate()
{
    GOSignal *signal = this->input()->signal()->at(0);
    GOMarkovOperator *prev = (GOMarkovOperator*)signal->next(this);
    int index = prev->output()->getSignalIndex(signal);
...
void GOMarkovOperator9A2::save(QDomDocument &document, QDomElement &root)
{
...
bool GOMarkovOperator9A2::tryOpen(QDomElement &root)
{
