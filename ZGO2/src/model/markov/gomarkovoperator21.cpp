...
bool GOMarkovOperator21::isDualBreakdown() const
{
    return this->_isDualBreakdown;
}

bool GOMarkovOperator21::isBreakdownCorrelate() const
{
    return this->_isBreakdownCorrelate;
}

void GOMarkovOperator21::setDualBreakdown(bool value)
{
    this->_isDualBreakdown = value;
}

void GOMarkovOperator21::setBreakdownCorrelate(bool value)
{
    this->_isBreakdownCorrelate = value;
}

GOMarkovStatus* GOMarkovOperator21::markovStatus2() const
{
    return this->_markovStatus2;
}

void GOMarkovOperator21::initMarkovStatus(double time, double c12)
{
...
void GOMarkovOperator21::calcOutputMarkovStatusNormal()
{
...
void GOMarkovOperator21::calcOutputMarkovStatusCorrelate()
{
    GOSignal *signal = this->input()->signal()->at(0);
    GOMarkovOperator *prev = (GOMarkovOperator*)signal->next(this);
    int index = prev->output()->getSignalIndex(signal);
...
void GOMarkovOperator21::save(QDomDocument &document, QDomElement &root)
{
...
bool GOMarkovOperator21::tryOpen(QDomElement &root)
{
