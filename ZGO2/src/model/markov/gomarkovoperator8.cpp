...
bool GOMarkovOperator8::isDualBreakdown() const
{
    return this->_isDualBreakdown;
}

bool GOMarkovOperator8::isBreakdownCorrelate() const
{
    return this->_isBreakdownCorrelate;
}

void GOMarkovOperator8::setDualBreakdown(bool value)
{
    this->_isDualBreakdown = value;
}

void GOMarkovOperator8::setBreakdownCorrelate(bool value)
{
    this->_isBreakdownCorrelate = value;
}

GOMarkovStatus* GOMarkovOperator8::markovStatus2() const
{
    return this->_markovStatus2;
}

void GOMarkovOperator8::initMarkovStatus(double time, double c12)
{
...
void GOMarkovOperator8::calcOutputMarkovStatus(double time)
{
    Q_UNUSED(time);
...
void GOMarkovOperator8::calcOutputMarkovStatusNormal()
{
...
void GOMarkovOperator8::calcOutputMarkovStatusCorrelate()
{
    GOSignal *signal = this->input()->signal()->at(0);
    GOMarkovOperator *prev = (GOMarkovOperator*)signal->next(this);
    int index = prev->output()->getSignalIndex(signal);
...
void GOMarkovOperator8::save(QDomDocument &document, QDomElement &root)
{
...
bool GOMarkovOperator8::tryOpen(QDomElement &root)
{
