...
bool GOMarkovOperator15A::isDualBreakdown() const
{
    return this->_isDualBreakdown;
}

bool GOMarkovOperator15A::isBreakdownCorrelate() const
{
    return this->_isBreakdownCorrelate;
}

void GOMarkovOperator15A::setDualBreakdown(bool value)
{
    this->_isDualBreakdown = value;
}

void GOMarkovOperator15A::setBreakdownCorrelate(bool value)
{
    this->_isBreakdownCorrelate = value;
}

GOMarkovStatus* GOMarkovOperator15A::markovStatus2() const
{
    return this->_markovStatus2;
}

void GOMarkovOperator15A::initMarkovStatus(double time, double c12)
{
...
void GOMarkovOperator15A::calcOutputMarkovStatusNormal()
{
...
void GOMarkovOperator15A::calcOutputMarkovStatusCorrelate()
{
    GOSignal *signal = this->input()->signal()->at(0);
    GOMarkovOperator *prev = (GOMarkovOperator*)signal->next(this);
    int index = prev->output()->getSignalIndex(signal);
...
void GOMarkovOperator15A::save(QDomDocument &document, QDomElement &root)
{
...
bool GOMarkovOperator15A::tryOpen(QDomElement &root)
{
