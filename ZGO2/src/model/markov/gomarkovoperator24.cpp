...
bool GOMarkovOperator24::isDualBreakdown() const
{
    return this->_isDualBreakdown;
}

bool GOMarkovOperator24::isBreakdownCorrelate() const
{
    return this->_isBreakdownCorrelate;
}

void GOMarkovOperator24::setDualBreakdown(bool value)
{
    this->_isDualBreakdown = value;
}

void GOMarkovOperator24::setBreakdownCorrelate(bool value)
{
    this->_isBreakdownCorrelate = value;
}

GOMarkovStatus* GOMarkovOperator24::markovStatus2() const
{
    return this->_markovStatus2;
}

void GOMarkovOperator24::initMarkovStatus(double time, double c12)
{
...
void GOMarkovOperator24::calcOutputMarkovStatus(double time)
{
    Q_UNUSED(time);
...
void GOMarkovOperator24::calcOutputMarkovStatusNormal()
{
...
void GOMarkovOperator24::calcOutputMarkovStatusCorrelate()
{
    GOSignal *signal = this->input()->signal()->at(0);
    GOMarkovOperator *prev = (GOMarkovOperator*)signal->next(this);
    int index = prev->output()->getSignalIndex(signal);
...
void GOMarkovOperator24::save(QDomDocument &document, QDomElement &root)
{
...
bool GOMarkovOperator24::tryOpen(QDomElement &root)
{
