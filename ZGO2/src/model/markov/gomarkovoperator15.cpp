...
bool GOMarkovOperator15::isDualBreakdown() const
{
    return this->_isDualBreakdown;
}

bool GOMarkovOperator15::isBreakdownCorrelate() const
{
    return this->_isBreakdownCorrelate;
}

void GOMarkovOperator15::setDualBreakdown(bool value)
{
    this->_isDualBreakdown = value;
}

void GOMarkovOperator15::setBreakdownCorrelate(bool value)
{
    this->_isBreakdownCorrelate = value;
}

GOMarkovStatus* GOMarkovOperator15::markovStatus2() const
{
    return this->_markovStatus2;
}

void GOMarkovOperator15::initMarkovStatus(double time, double c12)
{
...
void GOMarkovOperator15::calcOutputMarkovStatus(double time)
{
    Q_UNUSED(time);
...
void GOMarkovOperator15::calcOutputMarkovStatusNormal()
{
...
void GOMarkovOperator15::calcOutputMarkovStatusCorrelate()
{
    GOSignal *signal = this->input()->signal()->at(0);
    GOMarkovOperator *prev = (GOMarkovOperator*)signal->next(this);
    int index = prev->output()->getSignalIndex(signal);
...
void GOMarkovOperator15::save(QDomDocument &document, QDomElement &root)
{
...
bool GOMarkovOperator15::tryOpen(QDomElement &root)
{
