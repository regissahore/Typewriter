...
bool GOMarkovOperator11::isDualBreakdown() const
{
    return this->_isDualBreakdown;
}

bool GOMarkovOperator11::isBreakdownCorrelate() const
{
    return this->_isBreakdownCorrelate;
}

void GOMarkovOperator11::setDualBreakdown(bool value)
{
    this->_isDualBreakdown = value;
}

void GOMarkovOperator11::setBreakdownCorrelate(bool value)
{
    this->_isBreakdownCorrelate = value;
}

GOMarkovStatus* GOMarkovOperator11::markovStatus2() const
{
    return this->_markovStatus2;
}

void GOMarkovOperator11::initMarkovStatus(double time, double c12)
{
...
void GOMarkovOperator11::calcOutputMarkovStatusNormal()
{
...
void GOMarkovOperator11::calcOutputMarkovStatusCorrelate()
{
    GOSignal *signal = this->input()->signal()->at(0);
    GOMarkovOperator *prev = (GOMarkovOperator*)signal->next(this);
    int index = prev->output()->getSignalIndex(signal);
