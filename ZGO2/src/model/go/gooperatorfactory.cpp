...
GOOperator* GOOperatorFactory::produce(const int type)
{
    ...
    op->setId(GOOperatorFactory::_autoID++);
    op->setType(type);
    switch (type)
    {
 ...
 */
void GOOperatorFactory::setID(const int id)
{
    GOOperatorFactory::_autoID = id;
}
 ...
 * @return Current ID.
 */
int GOOperatorFactory::currentID()
{
    return GOOperatorFactory::_autoID;
}
