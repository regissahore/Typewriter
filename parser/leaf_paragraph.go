...
func parseLeafParagraph(doc *Document, source *UTF8String, offset, last int) (bool, int) {
	doc.AddElement(NewElementLeafParagraph(paragraphTrim(source.Substring(offset, last-offset))))
